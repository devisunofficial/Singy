...
It is an mp3 player I build because I wanted a mp3 player but not wanted to buy one.
It is incpired from iPod but it is not that good (I never had iPod)

### Features:

 - Minimilist. Just a display and Trackpad
 - 2.8 inch non touch display
 - Circular trackpad (but no haptics)
 - Have Wifi, Bluetooth and 3.5mm Headphone Jack
 - Inbuilt DAC and AMP
...
This MP3 player uses CPP for firmware language.
Features after completion:
 ...
 - In final version, you need to save some of your favourite songs, and at your preferred date and time library will be updated.(Might need a   server for this) 
...
2. If Everything works, stick battery and PCB to their Respective grooves.
